  ...
  <view class="sk-container">
    <scroll-view :scroll-y="true" class="viewport viewport">
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-385 sk-text">79.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-830 sk-text"
            >给衣柜减减肥，真空防潮压缩袋</view
          >
          <view class="desc sk-transparent sk-text-0-0000-721 sk-text">手动压缩，节省空间app</view>
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-562 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-359 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-861 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-640 sk-text">
              请选择收获地址
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-706 sk-text">服务</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-62 sk-text">
              无忧退 快速退款 免费包邮
            </text>
          </view>
        </view>
      ...
      <view class="detail detail panel panel">
        <view class="title title">
          <text class="sk-transparent sk-text-0-0000-534 sk-text">详情</text>
        </view>
        <view class="content content">
          <view class="properties properties">
            <view class="item item">
              <text class="label sk-transparent sk-text-25-0000-558 sk-text">材质</text>
              <text class="value sk-transparent sk-text-25-0000-158 sk-text">塑料</text>
            </view>
          </view>
        </view>
      </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 34px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-32-4324-493 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-32-4324-143 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
